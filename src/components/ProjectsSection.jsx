...
const projects = [
    {
        id: 1,
        title: "Coming Soon",
        description: "This section is under construction. Please check back later for exciting projects!",
    ...
    return <section id="projects" className="py-24 px-4 relative">
        <div className="container mx-auto max-w-5xl">
            ...
            <div className="text-center mt-12">
                <a href="https://github.com/Ardit-K" className="cosmic-button w-fit flex items-center mx-auto gap-2" target="_blank">
